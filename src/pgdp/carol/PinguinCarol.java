	...
	public static void main(String[] args) {
		...
		else
		{
			...
			for (int i=0;i<height;i++)
			{
				...
				{
					board [i][j] = randomInt(height-1-i,j);
				}
			}
				...
				while (inst != 'e')
				{
					...
					else if(inst == 's')
					{
						if (dir == 0)
						{
							...
							else
							{
								...
								if (Math.abs(board[posX][posY]-board[posX+1][posY]) > 1)write("Carol cannot go to the next field because the difference in height is too great.");
							}
						}
						else if(dir == 1)
						{
							...
							else
							{
								...
								if (Math.abs(board[posX][posY]-board[posX][posY+1]) > 1)write("Carol cannot go to the next field because the difference in height is too great.");
							}
						}
						else if(dir == 2 )
						{
					...
					else if(inst == 'n')
					{
						if(dir == 0 )
						{
							...
							{
								if(blockNum == 10) write("Carol can't take a block of ice, she's already carrying ten.");
								...
								if(board[posX+1][posY] <= -1) write("Carol can't take a block of ice, there aren't any left.");
							}
						}
						else if(dir == 1 )
						{
							...
							else
							{
								...
								if(board[posX][posY+1] <= -1) write("Carol can't take a block of ice, there aren't any left.");
							}
						}
						else if(dir ==2 )
						{
					...
					else if(inst == 'p')
					{
						if(dir == 0 )
						{
							...
							{
								if(blockNum < 1) write("Carol can't lay a block of ice because she isn't carrying one.");
								...
								if(board[posX+1][posY] >= 9) write("Carol can't lay a block of ice, there are already ten blocks of ice on the field.");
							}
						}
						else if (dir == 1)
						{
							...
							else
							{
								...
								if(board[posX][posY+1] >= 9) write("Carol can't lay a block of ice, there are already ten blocks of ice on the field.");
							}
						}
						else if(dir == 2)
						{
